...
basalt_run_tests(28, 'LOGOUT TESTS', 'Simple tests of the logout command.');

// -------------------------- DEFINITIONS AND TESTS -----------------------------------

function basalt_test_define_0028() {
    basalt_run_single_direct_test(28, 'FAIL: Log Out Non-Logged-In User', 'Do not log in, and try logging out. We expect to get a 403 error code.', 'user_tests');
}
...
function basalt_test_define_0029() {
    basalt_run_single_direct_test(29, 'FAIL: Log Out Logged-In Low-Level User', 'Log in, and try logging out. This should work the first time, but fail the second time.', 'user_tests', 'norm', '', 'CoreysGoryStory');
}
...
function basalt_test_define_0030() {
    basalt_run_single_direct_test(30, 'FAIL: Log Out Logged-In Normal User', 'Log in, and try logging out. This should work the first time, but fail the second time.', 'user_tests', 'krait', '', 'CoreysGoryStory');
}
...
function basalt_test_define_0031() {
    basalt_run_single_direct_test(31, 'FAIL: Log Out Logged-In Manager User', 'Log in, and try logging out. This should work the first time, but fail the second time.', 'user_tests', 'asp', '', 'CoreysGoryStory');
}
...
function basalt_test_define_0032() {
    basalt_run_single_direct_test(32, 'FAIL: Log Out Logged-In God User', 'Log in, and try logging out. This should work the first time, but fail the second time.', 'user_tests', 'admin', '', CO_Config::god_mode_password());
}
