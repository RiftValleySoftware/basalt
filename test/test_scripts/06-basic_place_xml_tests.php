...
function basalt_test_define_0055() {
    basalt_run_single_direct_test(55, 'PASS: Do A Radius Search (No Login)', 'Do not log in, and saerch for meetings within 5Km of the Lincoln Memorial', 'dc_area_tests');
}
