...
function basalt_test_define_0004() {
    basalt_run_single_direct_test(4, 'PASS: List Users With Session (Manager Login)', 'Log in with a manager login, and see what users are returned. We then go in again with no login, and make sure the session works.', 'user_tests', 'asp', '', 'CoreysGoryStory');
}
