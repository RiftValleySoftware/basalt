...
basalt_run_tests(7, 'BASIC XML USER TESTS', 'In which our intrepid hero does some basic REST Logins, and asks for information about users in XML.');

// -------------------------- DEFINITIONS AND TESTS -----------------------------------

function basalt_test_define_0007() {
    basalt_run_single_direct_test(7, 'PASS: List Users (No Login)', 'Do not log in, and see what users are returned.', 'user_tests');
}
...
function basalt_test_define_0008() {
    basalt_run_single_direct_test(8, 'PASS: List Users (Normal Login)', 'Log in with a standard login, and see what users are returned.', 'user_tests', 'norm', '', 'CoreysGoryStory');
}
...
function basalt_test_define_0009() {
    basalt_run_single_direct_test(9, 'PASS: List Users (Manager Login)', 'Log in with a manager login, and see what users are returned.', 'user_tests', 'asp', '', 'CoreysGoryStory');
}
...
function basalt_test_define_0010() {
    basalt_run_single_direct_test(10, 'PASS: List Users With Logins (Manager Login)', 'Log in with a manager login, and see what users are returned.', 'user_tests', 'asp', '', 'CoreysGoryStory');
}
...
function basalt_test_define_0011() {
    basalt_run_single_direct_test(11, 'PASS: List Users With Session (Manager Login)', 'Log in with a manager login, and see what users are returned. We then go in again with no login, and make sure the session works.', 'user_tests', 'asp', '', 'CoreysGoryStory');
}
